    ...
    public override Object? this[String name]
    {
        ...
        set
        {
            switch (name)
            {
                ...
                case "Url": _Url = ValidHelper.ToString(value); break;
                case "Sort": _Sort = ValidHelper.ToInt32(value); break;
                case "Icon": _Icon = ValidHelper.ToString(value); break;
                case "Visible": _Visible = ValidHelper.ToBoolean(value); break;
                case "Necessary": _Necessary = ValidHelper.ToBoolean(value); break;
                case "NewWindow": _NewWindow = ValidHelper.ToBoolean(value); break;
