    ...
    public void CreateUpperTableMySql()
    {
        ...
        Assert.Equal("""
            Create Table If Not Exists `USER`(
            	...
            	MAILVERIFIED TINYINT NOT NULL DEFAULT 0 COMMENT '邮箱是否验证。',
            	MOBILE VARCHAR(50) COMMENT '手机。支持登录',
            	MOBILEVERIFIED TINYINT NOT NULL DEFAULT 0 COMMENT '手机是否验证。',
    ...
    public void CreateUnderlineTableMySql()
    {
        ...
        Assert.Equal("""
            Create Table If Not Exists `user`(
            	...
            	sex INT NOT NULL DEFAULT 0 COMMENT '性别。未知、男、女',
            	mail VARCHAR(50) COMMENT '邮件。支持登录',
            	mail_verified TINYINT NOT NULL DEFAULT 0 COMMENT '邮箱是否验证。',
            	mobile VARCHAR(50) COMMENT '手机。支持登录',
